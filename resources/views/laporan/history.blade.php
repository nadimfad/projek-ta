...
<div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    <div>
        <h1 class="text-3xl font-bold text-slate-800">Riwayat Seluruh Laporan</h1>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            <thead class="bg-slate-50 text-slate-500 uppercase text-[11px] tracking-wider">
                <tr>
                    <th class="px-6 py-5 text-left font-semibold">Mahasiswa</th>
                    <th class="px-6 py-5 text-left font-semibold">NIM</th>
                    <th class="px-6 py-5 text-left font-semibold">Kegiatan</th>
                    <th class="px-6 py-5 text-left font-semibold">Bentuk Gratifikasi</th>
                    <th class="px-6 py-5 text-left font-semibold">Keterangan</th>
                    <th class="px-6 py-5 text-left font-semibold">Foto</th>
                    <th class="px-6 py-5 text-right font-semibold">Tanggal</th>
                </tr>
            </thead>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition duration-200">
                    <td class="px-6 py-5 font-semibold text-slate-800">{{ $laporan->nama_mahasiswa }}</td>
                    <td class="px-6 py-5 text-slate-500">{{ $laporan->nim_mahasiswa }}</td>
                    <td class="px-6 py-5 text-slate-500">{{ $laporan->kegiatan?->jenis_kegiatan ?? '-' }}</td>
                    <td class="px-6 py-5 text-slate-500">{{ $laporan->bentuk_gratifikasi }}</td>
                    <td class="px-6 py-5 text-slate-500">{{ $laporan->keterangan ?? '-' }}</td>
                    ...
                    <td class="px-6 py-5 text-right text-slate-500">{{ $laporan->tanggal_kegiatan }}</td>
                </tr>
                @empty
                <tr>
